using BatDongSanProject.Application.Features.Products.Commands;
using BatDongSanProject.Application.Features.Products.Commands.CreateProduct;
using BatDongSanProject.Application.Features.Products.Commands.DeleteProductById;
using BatDongSanProject.Application.Features.Products.Commands.UpdateProduct;
using BatDongSanProject.Application.Features.Products.Queries.GetAllProducts;
using BatDongSanProject.Application.Features.Products.Queries.GetProductById;
