...
{
    public partial class update_all_entities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CurrentMoney = table.Column<double>(nullable: false),
                    MoneyDeals = table.Column<double>(nullable: false),
                    UserId = table.Column<string>(nullable: true),
                    Status = table.Column<int>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FrontiSpiece = table.Column<float>(nullable: false),
                    Wayin = table.Column<float>(nullable: false),
                    ...
                    Juridical = table.Column<string>(nullable: true),
                    ...
                    Phone = table.Column<string>(nullable: true),
                    Email = table.Column<string>(nullable: true),
                    MessageBoardType = table.Column<int>(nullable: false),
                    StartDate = table.Column<DateTime>(nullable: false),
                    EndDate = table.Column<DateTime>(nullable: false),
                    FormalityId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Posts_Formalities_FormalityId",
                        column: x => x.FormalityId,
